...
query:
  echo "psql {{ forward_variables_with(' ', '-v ', '=', 'host', 'port') }} -f query.sql"
```

```console
$ just host=prod.example.com port=8080 query
psql -v host='prod.example.com' -v port='8080' -f query.sql
```
